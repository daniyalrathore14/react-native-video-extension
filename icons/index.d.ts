...
export declare type IconConfig = Partial<Record<'fullscreenIcon' | 'exitFullscreenIcon' | 'playIcon' | 'pauseIcon' | 'replayIcon' | 'forwardIcon' | 'refreshIcon' | 'volumeOffIcon' | 'volumeUpIcon', ReactElement>>;
